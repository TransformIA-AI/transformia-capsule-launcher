...
- Added adversarial tests for unsafe refs, object keys, secret-shaped values, sensitive key names, live claims, boundary payloads, canonical public outputs and hostile override objects.
